      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-primary-foreground/80 hover:text-secondary transition-colors">
                <Facebook size={20} />
                <span>Follow on Facebook</span>
              </a>
              <a href="mailto:contact@adijaacuil.com" className="flex items-center gap-2 text-primary-foreground/80 hover:text-secondary transition-colors">
                <Mail size={20} />
                <span>contact@adijaacuil.com</span>
              </a>
            </div>
            <p className="mt-4 text-primary-foreground/60 text-sm">
              Followed by 1K+ on Facebook
            </p>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-primary-foreground/20 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <p className="text-primary-foreground/70">
            © {new Date().getFullYear()} Adija Acuil. All rights reserved.
          </p>
          <p className="flex items-center gap-1 text-primary-foreground/70">
            Designed & built   by Simon A. Atem
          </p>
          <Link to="/admin" className="text-primary-foreground/50 hover:text-primary-foreground/80 transition-colors text-xs">
            Admin
          </Link>
        </div>
      </div>
